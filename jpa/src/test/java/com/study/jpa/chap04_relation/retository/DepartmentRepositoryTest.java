...
class DepartmentRepositoryTest {
    ...
    /*
        ...
        영속성 컨텍스트 내의 내용들을 DB에 반영시키거나 비워내거나 수명을 관이할 수 있는 객체. (commit, rollback, flush)
     */
    @Autowired
    EntityManager entityManager; // 작성하면 알아서 주입됨.
    ...
    void testLazyAndEager() {
        // 3번 사원을 조회하고 싶은데, 굳이 부서 정보는 필요 없음.
...
//        newDept.getEmployees().add(foundEmp);
        ...
        // 변경감지(더티 체크) 후 변경된 내용을 DB에 즉시 반영하는 로직
