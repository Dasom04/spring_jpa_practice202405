...
@Transactional // JPA 레파지토리는 트랜젝션 단위로 동작하기 때문에 작성 해주세요.
public class PostService {
    ...
    public PostDetailResponseDTO insert(PostCreateDTO dto) throws Exception { // throws Exception -> 문제는 컨트롤러로 넘기겠다는 뜻 (타입이 없어서 Exception)
