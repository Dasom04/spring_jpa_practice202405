...
public class PageResponseDTO {
    ...
    public PageResponseDTO(Page<Post> pageData) { // 생성자
        ...
        this.endPage = (int) (Math.ceil((double) currentPage / PAGE_COUNT) * PAGE_COUNT); // 끝 페이지 구하기 (공식)
        this.startPage = endPage - PAGE_COUNT + 1;

        int realEnd = pageData.getTotalPages(); // 마지막 페이지
